...
CeresSE3PriorFactor::addToProblem(boost::shared_ptr<ceres::Problem> problem)
{
    ...
    // std::cout << "CeresSE3PriorFactor cost function block size: " << cf_->parameter_block_sizes().size() << std::endl;
    // if (cf_->parameter_block_sizes().size() == 19) std::cout << "CeresSE3PriorFactor cost function block size equals19" << std::endl;
    if (cf_->parameter_block_sizes().size() == 10) std::cout << "CeresSE3PriorFactor cost function block size equals10" << std::endl;
