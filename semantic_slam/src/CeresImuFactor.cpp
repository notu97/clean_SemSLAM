...
{
    active_ = true;
    // std::cout << "CeresImuFactor cost function block size: " << cf_->parameter_block_sizes().size() << std::endl;
    // if (cf_->parameter_block_sizes().size() == 19) std::cout << "CeresImuFactor cost function block size equals19" << std::endl;
    if (cf_->parameter_block_sizes().size() == 10) std::cout << "CeresImuFactor cost function block size equals10" << std::endl;
