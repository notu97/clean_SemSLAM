                                ...
                                bool compute_covariance)
{
    ...
    // std::cout << "size_t m: " << m << " size_t k: " << k << std::endl;
    ...
    // std::cout << "geometry cost function 1 block size: " << proj_cost->parameter_block_sizes().size() << std::endl;
    // // if (proj_cost->parameter_block_sizes().size() == 19) std::cout << "geometry cost function 1 block size equals19" << std::endl;
    // // if (proj_cost->parameter_block_sizes().size() == 10) std::cout << "geometry cost function 1 block size equals10" << std::endl;
    // if (proj_cost->parameter_block_sizes().size() != params.size()){
    //     std::cout << "geometry cost function 1 block size and param unequal" << std::endl;
    //     std::cout << "geometry cost function 1 block size: " << proj_cost->parameter_block_sizes().size() << std::endl;
    //     std::cout << "geometry cost function 1 param: " << params.size() << std::endl;
    // } 
    ...
    // std::cout << "Geometry cost function 2 block size: " << pose_prior->parameter_block_sizes().size() << std::endl;
    // if (pose_prior->parameter_block_sizes().size() == 19) std::cout << "Geometry cost function 2 block size equals19" << std::endl;
    // if (pose_prior->parameter_block_sizes().size() == 10) std::cout << "Geometry cost function 2 block size equals10" << std::endl;
