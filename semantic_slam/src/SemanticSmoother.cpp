        ...
        if (graph_->modified()) {
            ...
            if (loop_closure_added) {
                ...
                if (tryOptimize()) {
                    ...
                    // std::cout << "finish computing covariance." << std::endl;
                }
            }
...
SemanticSmoother::tryAddObjectsToGraph()
{
    ...
    // std::cout << "add_object_1" << std::endl;
    ...
    // std::cout << "add_object_2" << std::endl;
}
...
SemanticSmoother::tryOptimize()
{
    ...
    // std::cout << "Solve Graph time taken at time " << std::setiosflags(std::ios::fixed)<<std::setprecision(10)
    //     << ros::Time::now().toSec() << ": " << std::chrono::duration_cast<std::chrono::microseconds>(duration).count() / 1000. << " ms" << std::endl;
    // fflush(stdout);
    
    // std::cout << "number of nodes: " << graph_->num_nodes() << std::endl;
    // std::cout << "number of factors: " << graph_->num_factors() << std::endl;
    ...
    // for (auto& factor: graph_->factors()) {
    //     if (factor->active()) {
    //         numFactors += 1;
    //     }
    // }
    // std::cout << "number of nodes: " << numNodes << std::endl;
    // std::cout << "number of factors: " << numFactors << std::endl;
