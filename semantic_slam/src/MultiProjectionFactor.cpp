  ...
  boost::shared_ptr<ceres::Problem> problem)
{
    ...
    // std::cout << "MultiProjectionFactor cost function block size: " << this->parameter_block_sizes().size() << std::endl;
    // if (this->parameter_block_sizes().size() == 19) std::cout << "MultiProjectionFactor cost function block size equals19" << std::endl;
    if (this->parameter_block_sizes().size() == 10) std::cout << "MultiProjectionFactor cost function block size equals10" << std::endl;
