...
class EstimatedObject : public boost::enable_shared_from_this<EstimatedObject>
{
  public:
    ...
    double computeMahalanobisAndDet(const ObjectMeasurement& msmt, double& det, double avg_objz) const;
    ...
    Key first_frame_key() const { return first_frame_key_; }
    ...
    const Eigen::VectorXd getCoefficients() {return basis_coefficients_;} 
